    ...
    return (
      ...
      <div className='cddddd'>
        ...
        <div className='flex justify-center text-center items-center flex-col w-full'>
          ...
          {t('Congratulations ! Your Salon Has Been Verified .  .')}  </h1>
            <h2 className='w-2/3 font-semibold'>
            Lorem ipsum dolor sit amet consectetur. Eu sed felis velit ac quisqu</h2>
        <div className='w-2/3 mt-9'><MainButton text={'going to dashboard'} /></div>
        </div>
      </Box>
        </Modal>
